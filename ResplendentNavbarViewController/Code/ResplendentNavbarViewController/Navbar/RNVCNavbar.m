...
{
    CGFloat width = CGRectGetWidth(self.animatableContentViewFrame);
    CGFloat height = [_titleLabel.text sizeWithFont:_titleLabel.font constrainedToSize:(CGSize){width,CGFLOAT_MAX}].height;
    CGFloat titleLabelTopEdgeInset = self.titleLabelTopEdgeInset;
//    CGFloat width = [_titleLabel.text sizeWithFont:_titleLabel.font].width;
    return (CGRect){
        CGRectGetHorizontallyAlignedXCoordForWidthOnWidth(width, CGRectGetWidth(self.frame)),
        titleLabelTopEdgeInset,
        width,
        height
    };
}
